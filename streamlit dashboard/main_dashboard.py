...
@st.cache_resource
def load_data():
    data = pd.read_csv("C:\ilham files\informatika ilham\Bangkit - ML 24\code\streamlit-bike\streamlit dashboard\hour.csv")
    return data
...
st.sidebar.markdown("**• Nama: ILHAM YULIANTO**")
st.sidebar.markdown(
    "**• Email: ilhamyulianto6@gmail.com**")
...
# Show dataset source
st.sidebar.markdown('**Weathersit Description:**')
...
st.sidebar.info("This dashboard displays visualizations for a set of Bike Share data. "
